...
Если поискать слово "Дейкстра" на \httplink{https://habr.com}{хабре}, то мы увидим примерно 18 страниц результатов, по 20 статей на каждой. Довольно трудно при этом претендовать на самую понятную статью, объясняющую этот алгоритм. Тем не менее, я попытался.
