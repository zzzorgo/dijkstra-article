...
\begin{figure}
    ...
    \begin{styledtikz}
        \begin{scope}[local bounding box=graph1, spring layout]
            \node (a) [baseNode] {\splittext{a}{100}};
            \node (start) [baseNode, reverseNode] {start};
            \node (b) [baseNode] {b};
            \node (c) [baseNode, reverseNode] {c};
            \node (d) [baseNode, disabledNode, dashedPath] {};
            \node (e) [baseNode, disabledNode, dashedPath] {};
            \node (f) [baseNode, disabledNode, dashedPath] {};
            \node (g) [baseNode, disabledNode, dashedPath] {};
            \node (cc) [baseNode, disabledNode, dashedPath] {};
            \node (end) [baseNode] {end};
