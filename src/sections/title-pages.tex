...
\begin{titlepage}
    ...
    \newgeometry{textwidth=10cm, onecolumn, top=0cm, bottom=0cm}
    ...
    Конечно, я гуглил различные статьи и смотрел книги, которые могли бы его объяснить. Почему-то ни одно из найденных мной объяснений не отличалось понятностью. В какой-то момент я добрался до этого алгоритма в книге Стивена Скиены "Алгоритмы. Руководство по разработке". Книга написано крайне... странно. Все примеры кода с однобуквенными переменными как будто специально обфусцированы, а объяснения хода выполнения неполные. Не хочу преуменьшать мастерство автора в написании алгоритмов, он явно в этом хорош, но книга вышла не самой простой.

    В итоге, посидев над кодом в IDE и изрядно почитав самых разных объяснений, я пришел к пониманию, которым и хочу поделиться. Надеюсь, мои страдания помогли сделать эту статью более понятной, чем остальные источники.

    \subsection*{Ссылки}

    При оформлении я вдохновлялся прекрасной работой от Pluralsight: \httplink{\pluralsightArticleUrl}{"20 patterns to watch for in your engineering team"}.
